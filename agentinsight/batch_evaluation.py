"""Batch evaluation functionality for AgentInsight.

This module provides comprehensive batch evaluation capabilities for running evaluations
on traces and observations fetched from AgentInsight. It includes type definitions,
...
from agentinsight.experiment import Evaluation, EvaluatorFunction
...
class EvaluatorInputs:
    ...
    Examples:
        ...
        ```python
        from agentinsight import EvaluatorInputs
...
class BatchEvaluationRunner:
    """Handles batch evaluation execution for an AgentInsight client.
    ...
    separation of concerns from the main AgentInsight client class.
    ...
    Attributes:
        client: The AgentInsight client instance used for API calls and score creation.
    """

    def __init__(self, client: "AgentInsight"):
        """Initialize the batch evaluation runner.

        Args:
            client: The AgentInsight client instance.
        """
        self.client = client
    ...
    async def run_async(
        ...
        *,
        ...
        # Flush all scores to AgentInsight
        if verbose:
            logger.info("Flushing scores to AgentInsight...")
        self.client.flush()
