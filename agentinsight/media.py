"""This module contains the AgentInsightMedia class, which is used to wrap media objects for upload to AgentInsight."""
...
from agentinsight.api import MediaContentType
from agentinsight.logger import agentinsight_logger as logger
from agentinsight.types import ParsedMediaReference
...
class AgentInsightMedia:
    """A class for wrapping media objects for upload to AgentInsight.

    This class handles the preparation and formatting of media content for AgentInsight,
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize an AgentInsightMedia object.
        ...
        if base64_data_uri is not None:
            ...
            logger.error(
                "base64_data_uri, or content_bytes and content_type, or file_path must be provided to AgentInsightMedia"
            )
    ...
    def resolve_media_references(
        *,
        ...
        Args:
            ...
            agentinsight_client: AgentInsight client instance used to fetch media content.
        ...
        def traverse(obj: Any, depth: int) -> Any:
            ...
            if isinstance(obj, str):
                ...
                httpx_client = (
                    agentinsight_client._resources.httpx_client
                    if agentinsight_client._resources is not None
                    else None
                )

                for reference_string in reference_string_matches:
                    try:
                        parsed_media_reference = (
                            AgentInsightMedia.parse_reference_string(reference_string)
                        )
                        media_data = agentinsight_client.api.media.get(
