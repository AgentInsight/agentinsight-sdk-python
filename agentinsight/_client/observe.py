...
from agentinsight._client.get_client import _set_current_public_key, get_client
...
class AgentInsightDecorator:
    """Implementation of the @observe decorator for seamless AgentInsight tracing integration.

    This class provides the core functionality for the @observe decorator, which enables
    automatic tracing of functions and methods in your application with AgentInsight.
    It handles both synchronous and asynchronous functions, maintains proper trace context,
    and intelligently routes to the correct AgentInsight client instance.
    ...
    - Thread-safe client resolution when multiple AgentInsight projects are used
    """
    ...
    def observe(
        ...
        *,
        ...
        """Wrap a function to create and manage AgentInsight tracing around its execution, supporting both synchronous and asynchronous functions.

        This decorator provides seamless integration of AgentInsight observability into your codebase. It automatically creates
        ...
        Args:
            ...
            as_type (Optional[Literal]): Set the observation type. Supported values:
                    ...
                    Observation types are highlighted in the AgentInsight UI for filtering and visualization.
                    The types "generation" and "embedding" create a span on which additional attributes such as model metrics
                    can be set.

        Returns:
            Callable: A wrapped version of the original function that automatically creates and manages AgentInsight spans.
        ...
        Notes:
            ...
            - Special keyword arguments can be passed to control tracing:
              - langfuse_trace_id / agentinsight_trace_id: Explicitly set the trace ID for this function call
              - langfuse_parent_observation_id / agentinsight_parent_observation_id: Explicitly set the parent span ID
              - langfuse_public_key / agentinsight_public_key: Use a specific AgentInsight project (when multiple clients exist)
        ...
        function_io_capture_enabled = os.environ.get(
            AGENTINSIGHT_OBSERVE_DECORATOR_IO_CAPTURE_ENABLED, "True"
        ...
        *,
        ...
        async def async_wrapper(*args: Tuple[Any], **kwargs: Dict[str, Any]) -> Any:
            trace_id = cast(
                ...
                or kwargs.pop("agentinsight_trace_id", None),
            )
            parent_observation_id = cast(
                str,
                kwargs.pop("langfuse_parent_observation_id", None)
                or kwargs.pop("agentinsight_parent_observation_id", None),
            )
            ...
            with _set_current_public_key(public_key):
                ...
                context_manager: Optional[
                    ...
                    agentinsight_client.start_as_current_observation(
                        name=final_name,
                ...
                with context_manager as agentinsight_span_or_generation:
                    ...
                    try:
                        ...
                        (
                            ...
                            agentinsight_span_or_generation,
                            result,
                        ...
                        agentinsight_span_or_generation.update(
                        ...
                        if not is_return_type_generator:
                            agentinsight_span_or_generation.end()
    ...
    def _sync_observe(
        ...
        *,
        ...
        def sync_wrapper(*args: Any, **kwargs: Any) -> Any:
            trace_id = kwargs.pop("langfuse_trace_id", None) or kwargs.pop(
                "agentinsight_trace_id", None
            )
            parent_observation_id = kwargs.pop(
            ...
            public_key = kwargs.pop("langfuse_public_key", None) or kwargs.pop(
                "agentinsight_public_key", None
            )
    ...
    def _wrap_sync_generator_result(
        self,
        agentinsight_span_or_generation: Union[
            AgentInsightSpan,
            AgentInsightGeneration,
            AgentInsightAgent,
            AgentInsightTool,
    ...
    def _handle_observe_result(
        ...
        *,
        ...
        if capture_output is True:
            agentinsight_span_or_generation.update(output=result)

        return False, result


_decorator = AgentInsightDecorator()
