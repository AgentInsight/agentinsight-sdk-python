...
from agentinsight._client.environment_variables import AGENTINSIGHT_MEDIA_UPLOAD_ENABLED
from agentinsight._utils import _get_timestamp
from agentinsight.api import LangfuseAPI, MediaContentType
    ...
    def _find_and_process_media(
        ...
        *,
        ...
        def _process_data_recursively(data: Any, level: int) -> Any:
            ...
            if isinstance(data, AgentInsightMedia):
                self._process_media(
                    media=data,
                    trace_id=trace_id,
