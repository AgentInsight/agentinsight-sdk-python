...
def reset_agentinsight_state(request: pytest.FixtureRequest) -> Iterable[None]:
...
reset_langfuse_state = reset_agentinsight_state
...
@pytest.fixture
def agentinsight_memory_client(
    ...
    monkeypatch.setenv("AGENTINSIGHT_BASE_URL", "http://test-host")
...
langfuse_memory_client = agentinsight_memory_client
