...
from agentinsight._client.observe import (
...
def test_sync_generator_preserves_context_without_output_capture(
    ...
    assert AgentInsightOtelSpanAttributes.OBSERVATION_OUTPUT not in root_span.attributes
...
async def test_streaming_response_preserves_context_without_output_capture(
    ...
    assert (
        ...
        not in endpoint_span.attributes
    )
