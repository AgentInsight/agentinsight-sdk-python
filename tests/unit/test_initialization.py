"""Test suite for Langfuse client initialization with AGENTINSIGHT_HOST and AGENTINSIGHT_BASE_URL.

This test suite verifies that both AGENTINSIGHT_HOST (deprecated) and AGENTINSIGHT_BASE_URL
...
class TestClientInitialization:
    ...
    def cleanup_env_vars(self):
        ...
        original_values = {
            "AGENTINSIGHT_BASE_URL": os.environ.get("AGENTINSIGHT_BASE_URL"),
            "AGENTINSIGHT_HOST": os.environ.get("AGENTINSIGHT_HOST"),
            "AGENTINSIGHT_PUBLIC_KEY": os.environ.get("AGENTINSIGHT_PUBLIC_KEY"),
            "AGENTINSIGHT_SECRET_KEY": os.environ.get("AGENTINSIGHT_SECRET_KEY"),
        }

        # Remove AGENTINSIGHT_BASE_URL and AGENTINSIGHT_HOST for the test
        # but keep PUBLIC_KEY and SECRET_KEY if they exist
        for key in ["AGENTINSIGHT_BASE_URL", "AGENTINSIGHT_HOST"]:
        ...
        with AgentInsightResourceManager._lock:
            AgentInsightResourceManager._instances.clear()
    ...
    def test_base_url_parameter_takes_precedence(self, cleanup_env_vars):
        ...
        os.environ["AGENTINSIGHT_BASE_URL"] = "http://env-base-url.com"
        os.environ["AGENTINSIGHT_HOST"] = "http://env-host.com"
    ...
    def test_env_base_url_takes_precedence_over_host_param(self, cleanup_env_vars):
        """Test that AGENTINSIGHT_BASE_URL env var takes precedence over host parameter."""
        os.environ["AGENTINSIGHT_BASE_URL"] = "http://env-base-url.com"
    ...
    def test_env_host_fallback(self, cleanup_env_vars):
        """Test that AGENTINSIGHT_HOST env var works as fallback."""
        os.environ["AGENTINSIGHT_HOST"] = "http://env-host.com"
    ...
    def test_default_base_url(self, cleanup_env_vars):
        ...
        assert client._base_url == "https://agent.goldebridge.com"

    def test_base_url_env_var(self, cleanup_env_vars):
        """Test that AGENTINSIGHT_BASE_URL environment variable is used correctly."""
        os.environ["AGENTINSIGHT_BASE_URL"] = "http://test-base-url.com"
    ...
    def test_host_env_var(self, cleanup_env_vars):
        """Test that AGENTINSIGHT_HOST environment variable is used correctly (deprecated)."""
        os.environ["AGENTINSIGHT_HOST"] = "http://test-host.com"
    ...
    def test_precedence_order_all_set(self, cleanup_env_vars):
        ...
        # Case 2: AGENTINSIGHT_BASE_URL env var wins when base_url param not set
        client2 = AgentInsight(
            host="http://param-host.com",
            public_key="test_pk",
            secret_key="test_sk",
        )
    ...
    def test_precedence_without_base_url(self, cleanup_env_vars):
        ...
        # Case 2: AGENTINSIGHT_HOST env var is used
        client2 = AgentInsight(
            public_key="test_pk",
            secret_key="test_sk",
        )
    ...
    def test_both_env_vars_set(self, cleanup_env_vars):
        """Test that AGENTINSIGHT_BASE_URL takes precedence over AGENTINSIGHT_HOST."""
        os.environ["AGENTINSIGHT_BASE_URL"] = "http://base-url.com"
        os.environ["AGENTINSIGHT_HOST"] = "http://host.com"
    ...
    def test_localhost_urls(self, cleanup_env_vars):
        ...
        # Test with env var
        os.environ["AGENTINSIGHT_BASE_URL"] = "http://localhost:3000"
        client3 = AgentInsight(
            public_key="test_pk",
            secret_key="test_sk",
        )
